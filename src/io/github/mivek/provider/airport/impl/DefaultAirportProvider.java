...
public final class DefaultAirportProvider implements AirportProvider {
    ...
    private final InputStream airportsFile = DefaultAirportProvider.class.getResourceAsStream("data/airports.dat");
    /** Path of countries file. */
    private final InputStream countriesFile = DefaultAirportProvider.class.getResourceAsStream("data/countries.dat");
    /** Map of countries. */
